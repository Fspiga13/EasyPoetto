		...
		<div class="company-details">
			<div class="form-row px-4 mt-3 align-items-center">
				<div id="col1" class= "col">
					<svg class="icon icon-position gi-3x"><use xlink:href="#icon-position"></use></svg>				
					<div>
						<small>Viale Lungo Mare Poetto n. 13</small> 
						<br/> 
						<small>09126 Cagliari CA, Italia</small>
					</div>
				</div>
				...
				<div id="col3" class= "col">
					<svg class="icon icon-envelope gi-2x mb-3"><use xlink:href="#icon-envelope"></use></svg>					
					<div><small>info@easypoetto.it</small></div>
				</div>
			</div>
		</div>
