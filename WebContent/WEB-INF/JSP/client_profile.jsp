				...
				<div id="main" class="shadow-lg border border-light p-5 rounded">
					...
					<form action="profile.html" method="post" accept-charset="utf-8">
					    ...
					    <div>
					  	...
					  	<input type="date" class="form-control mb-4" id="birthday" name="birthday" max="${today}" min="1900-01-01" required <c:if test= "${not empty client}">value="${client.birthdayString}"</c:if>/> 
						</div>
